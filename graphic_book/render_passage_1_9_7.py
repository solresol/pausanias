...
PASSAGE_ID = "1.9.7"
ASSET_DIR = root_dir() / "graphic_book/assets/generated/1_9_7"
MAIN_ART = ASSET_DIR / "main_ephesus_harbor_refoundation.png"
EPIRUS_ART = ASSET_DIR / "epirus_royal_tombs.png"
...
def make_locator_panel(records: list[FitRecord]) -> Image.Image:
    ...
    points = {
        "MACEDON": (map_rect[0] + 92, map_rect[1] + 82),
        "ASIA": (map_rect[0] + 218, map_rect[1] + 116),
        "EPHESUS": (map_rect[0] + 242, map_rect[1] + 132),
        "EPIRUS": (map_rect[0] + 64, map_rect[1] + 118),
    }
    asia_route = [points["MACEDON"], (map_rect[0] + 156, map_rect[1] + 98), points["ASIA"], points["EPHESUS"]]
    epirus_route = [points["MACEDON"], (map_rect[0] + 88, map_rect[1] + 104), points["EPIRUS"]]
    draw.line(asia_route, fill="#7b493a", width=4)
    draw.line(asia_route, fill="#f4ead6", width=1)
    draw.line(epirus_route, fill="#4e5f5d", width=3)
    draw.line((map_rect[0] + 184, map_rect[1] + 124, map_rect[0] + 294, map_rect[1] + 122), fill="#496b72", width=4)
    for x, y in points.values():
        draw.ellipse((x - 5, y - 5, x + 5, y + 5), fill="#6a4d2d", outline="#f6e8c4", width=2)

    label_specs = [
        ("MACEDON", (54, 126, 140, 150), "locator:macedon"),
        ("EPIRUS", (34, 176, 104, 200), "locator:epirus"),
        ("AEGEAN", (178, 172, 254, 196), "locator:aegean"),
        ("EPHESUS", (228, 194, 318, 218), "locator:ephesus"),
        ("ASIA", (210, 128, 276, 152), "locator:asia"),
    ]
    ...
    caption = "Pausanias turns from Lysimachus' crossing into Asia to a later western raid against Pyrrhus' Epirus."
    records.append(
        draw_fitted_text(
            draw,
...
def make_consequence_panel(records: list[FitRecord]) -> Image.Image:
    ...
    rows = [
        ("ANTIGONUS", "Asia changes hands after Lysimachus crosses by ship."),
        ("EPHESUS", "The city is gathered and extended down to the sea."),
        ("COLOPHON", "Phoenix laments the capture and removal of his city."),
        ("EPIRUS", "Pyrrhus' absence leaves royal tombs exposed to raid."),
    ]
    y = 78
...
def render_page(output_path: Path) -> dict[str, object]:
    ...
    paste_with_shadow(
        page,
        make_label("EPHESUS DRAWN TO THE SEA", title_rect, records, font_path=TITLE_FONT, max_size=25, min_size=11),
        (title_rect[0], title_rect[1]),
    )

    label_specs = [
        ("LYSIMACHUS ARRIVES", (466, 144, 724, 190), (578, 508), 19),
        ("EPHESUS", (758, 116, 934, 162), (830, 270), 22),
        ("CITY TO THE SEA", (872, 444, 1148, 490), (972, 458), 19),
        ("IONIAN HARBOR", (1098, 232, 1328, 278), (1170, 414), 19),
        ("COLOPHON AND LEBEDOS", (502, 532, 828, 578), (554, 594), 15),
    ]
    ...
    treaty_note = make_compact_callout(
        "In Asia, Lysimachus replaces Antigonus' power and remakes Ephesus as a seaward city.",
        (420, 88),
        "callout:treaty",
        records,
        max_size=15,
    )
    draw_polyline_leader(draw, [(468, 648), (620, 594), (870, 438)])
    paste_with_shadow(page, treaty_note, (462, 642))

    variant_note = make_compact_callout(
        "The relocation has a literary afterlife: Phoenix of Colophon mourns the old city; Hermesianax is remembered as already gone.",
        (458, 92),
        "callout:variant",
        records,
        max_size=14,
    )
    draw_polyline_leader(draw, [(910, 650), (1040, 604), (596, 594)])
    ...
    epirus_crop = crop_to_fill(EPIRUS_ART, (420, 210), centering=(0.50, 0.50))
    epirus_crop = warm_art(epirus_crop, grain_strength=0.018)
    epirus_panel = make_inset_panel(
        epirus_crop,
        "When Pyrrhus is away, the war reaches inland Epirus and even the kings' tombs.",
        98,
        "inset:epirus-caption",
        records,
    )
    paste_with_shadow(page, epirus_panel, (440, 762))
    epirus_label = (528, 780, 772, 816)
    draw_leader(draw, (670, 900), (epirus_label[0], epirus_label[1] + 18))
    paste_with_shadow(
        page,
        make_label("EPIRUS ROYAL TOMBS", epirus_label, records, max_size=15, min_size=6),
        (epirus_label[0], epirus_label[1]),
    )
    ...
    report = {
        ...
        "continuity_reference_pages": [
            ...
            "graphic_book/images/1/9/6.png",
        ],
        "sources": [
            {
                "path": str(MAIN_ART),
                "source_image": "/Users/gregb/.codex/generated_images/019ec74a-d586-76b0-a869-0d15875285ab/ig_016f58976f8122dd016a2eec7f32948191ba9b3001627b5b5e.png",
                "description": "Generated raster source; final page crops a wide Ephesus harbor refoundation tableau with the sea, civic center, quays, and incoming settlers visible.",
            },
            {
                "path": str(EPIRUS_ART),
                "source_image": "/Users/gregb/.codex/generated_images/019ec74a-d586-76b0-a869-0d15875285ab/ig_016f58976f8122dd016a2eeccf6e948191bf2e1eb6fc88de6d.png",
                "description": "Generated raster scenic inset showing a non-gory approach to Epirote royal tombs.",
            },
        ],
    }
    report_path = root_dir() / "tmp" / "passage_1_9_7_layout_report.json"
...
def main() -> None:
    output_path = root_dir() / "graphic_book" / "images" / "1" / "9" / "7.png"
