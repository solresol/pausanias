...
def get_noun_nodes(conn):
    ...
    query = """
    SELECT reference_form, entity_type, MIN(english_transcription) AS english_transcription
    FROM proper_nouns
...
<body>
    ...
    <div class="container">
        ...
        <footer>
            Generated on <span id="timestamp"></span> from the PostgreSQL database
        </footer>
    </div>
