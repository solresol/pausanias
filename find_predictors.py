...
def create_predictor_tables(conn):
    ...
    create_simplified_predictor_table(conn, "simplified_mythicness_predictors", "mythic")
    create_simplified_predictor_table(conn, "simplified_skepticism_predictors", "skeptical")
...
def create_classification_metrics_tables(conn):
    ...
    create_simplified_metrics_table(conn, "simplified_mythicness_metrics")
    create_simplified_metrics_table(conn, "simplified_skepticism_metrics")
    conn.commit()
...
def clear_predictor_tables(conn):
    ...
    conn.execute("DELETE FROM simplified_mythicness_predictors")
    conn.execute("DELETE FROM simplified_skepticism_predictors")
    conn.commit()
